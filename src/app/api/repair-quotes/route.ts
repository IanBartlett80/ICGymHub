    ...
    const [requests, total] = await Promise.all([
      prisma.repairQuoteRequest.findMany({
        ...
        select: {
          ...
          scheduledRepairDate: true,
          repairCompanyName: true,
          repairCompletedAt: true,
          repairCompletedBy: true,
          finalCost: true,
          completionNotes: true,
          warrantyInfo: true,
          icbAcknowledgedAt: true,
          icbAcknowledgedBy: true,
          statusHistory: true,
          emailSent: true,
          createdAt: true,
          updatedAt: true,
